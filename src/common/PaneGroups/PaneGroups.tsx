...
import { initialSchedulePaneGroup } from 'globals/initialSchedulePaneGroup'
...
export function PaneGroups(): JSX.Element {
  const [structure, setStructure] = useState<ITabPane | IPaneGroup>(initialSchedulePaneGroup)
